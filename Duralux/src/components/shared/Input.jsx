...
const Input = ({ label, icon, type = "text", placeholder, labelId, name, centerLink, required }) => {
    return (
        <div className="row mb-4 align-items-center">
            ...
            <div className="col-lg-8">
                <div className="input-group">
                    ...
                    <input type={type} name={name} className="form-control" id={labelId} placeholder={placeholder} required={required}/>
                </div>
            </div>
        </div>
    )
